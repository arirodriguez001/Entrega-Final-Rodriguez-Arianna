...
class Articulo(models.Model):
    ...
    articulo = models.CharField(max_length=15, choices=articuloSeleccion, default='remera')
...
class Comentario(models.Model):
    comentario = models.ForeignKey(Articulo, related_name='comentarios', on_delete=models.CASCADE, null=True)
